module Chapter9.FoldDir where

import           Chapter9.ControlledVisit (Info (..), getInfo,
                                           getUsefulContents, isDirectory)
...
foldTree iter initSeed path = do endSeed <- fold initSeed path
